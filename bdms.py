# PYTHONSTARTUP=bdms.py pyspark

from pyspark.sql import SparkSession
spark=SparkSession.builder.appName("lin_reg").getOrCreate()
df = spark.read.format("csv").option("header","true").option("inferSchema","true").load("/home/ravi/BDM/Project/Sofia Air quality_/2017-09_bme280sof.csv")
df.printSchema()
print(df.head())
df =df.na.drop()
